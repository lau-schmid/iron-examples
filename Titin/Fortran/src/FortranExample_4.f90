...
!        & CMFE_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.0_CMISSRP,Err) ! To change the initial half-sarcomere length. To create cases similar to Rode. 
        & CMFE_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.6_CMISSRP/stretch_sarcolength_ratio,Err) ! To change the initial half-sarcomere length. To create cases similar to Rode. 
    ENDIF
  ENDDO
