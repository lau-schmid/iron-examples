...
#mkdir -p results/current_run/l1x1_n4_i1_s0_01 && ./$folder/src/example 4 1 0 0.01 10 1 hodgkin_huxley_1952.cellml F 0.01 && mv *.ex* results/current_run/l1x1_n4_i1_s0_01
mkdir -p results/current_run/l1x1_n4_i1_s0_05 && ./$folder/src/example 4 1 0 0.05 10 1 hodgkin_huxley_1952.cellml F 0.05 && mv *.ex* results/current_run/l1x1_n4_i1_s0_05
...
#mkdir -p results/current_run/l1x1_n18_i1_s0_05 && ./$folder/src/example 18 1 0 0.05 10 1 hodgkin_huxley_1952.cellml F 0.05 && mv *.ex* results/current_run/l1x1_n18_i1_s0_05
